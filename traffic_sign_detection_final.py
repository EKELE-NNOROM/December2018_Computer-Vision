...
# -*- coding: utf-8 -*-
"""
Created on Sat Jan 12 14:00:25 2019
...
# returns batches of transformed images when requested (during training) not on all images in the dataset
datagen.fit(X_train)
...
model.save("TrainedModel/augmented_traffic_sign_detection.h5")
